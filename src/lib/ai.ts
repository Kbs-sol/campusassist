...
export class AIService {
  ...
  // Get context from Google Custom Search (restricted to campus domain)
      ...
      const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            {
              role: 'user',
              content: `Context from campus website:\n${context}\n\nQuestion: ${question}`
            }
          ],
          temperature: 0.7,
          max_tokens: 1000,
  ...
  formatHTML(text: string, sourceLinks: SearchResult[]): string {
    ...
    // Add disclaimer
    html += '<br><br><small><em>💡 This information is generated by AI and may not be completely accurate. For official information, please verify with campus administration or check the official website.</em></small>';
